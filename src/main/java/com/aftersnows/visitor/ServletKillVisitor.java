...
public class ServletKillVisitor extends ClassVisitor {

    public ServletKillVisitor(int api, ClassVisitor classVisitor) {
    ...
    public MethodVisitor visitMethod(int access, String methodName, String descriptor,
        ...
        if (methodVisitor != null && methodName.equals("service")) {
