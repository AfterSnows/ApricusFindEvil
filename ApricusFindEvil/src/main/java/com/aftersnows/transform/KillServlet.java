...
import com.aftersnows.visitor.ServletKillVisitor;
...
public class KillServlet implements ClassFileTransformer {
    private final String TargetClass;
    public byte[] data;
    public KillServlet(String targetClass) {
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer)  {
        ...
        if(className.equals(TargetClass)){
            ...
            ClassVisitor cv = new ServletKillVisitor(Opcodes.ASM9, cw);
