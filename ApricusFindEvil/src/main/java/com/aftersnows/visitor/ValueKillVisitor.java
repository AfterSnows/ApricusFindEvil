...
public class ValueKillVisitor extends ClassVisitor {

    public ValueKillVisitor(int api, ClassVisitor classVisitor) {
    ...
    public MethodVisitor visitMethod(int access, String methodName, String descriptor,
        ...
        if (methodVisitor != null && methodName.equals("invoke")) {
